...
::: {.battlecard-metadata}
**Category:** Developer Environment | **Scenario:** Secrets via Crash/Telemetry/Extensions

**Focus Areas:** IDE telemetry leaks, malicious extensions, crash dumps exposing secrets
:::
