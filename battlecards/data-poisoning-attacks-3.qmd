...
::: {.battlecard-metadata}
**Category:** AI/ML Supply Chain | **Scenario:** Training Data Poisoning

**Focus Areas:** injected malicious samples into public datasets, label flipping, backdoor triggers hidden in training data
:::
