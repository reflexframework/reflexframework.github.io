...
::: {.battlecard-metadata}
**Category:** Developer Environment | **Scenario:** Dev Containers / Post-Create Hooks

**Focus Areas:** VS Code DevContainer postCreateCommand, malicious devfiles, token exfiltration
:::
