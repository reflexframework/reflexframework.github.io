...
::: {.battlecard-metadata}
**Category:** AI/ML Security | **Scenario:** Model Extraction

**Focus Areas:** query-based extraction attacks, model inversion revealing training data, shadow models built from stolen responses
:::
