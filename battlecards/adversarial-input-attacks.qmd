...
::: {.battlecard-metadata}
**Category:** AI/ML Security | **Scenario:** Adversarial Examples

**Focus Areas:** crafted inputs to cause misclassification, bypassing filters in moderation systems, image/text perturbations that fool classifiers
:::
