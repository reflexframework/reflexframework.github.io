...
::: {.battlecard-metadata}
**Category:** AI/ML Security | **Scenario:** Agent and Plugin Abuse

**Focus Areas:** unsafe external tool execution, jailbreaks enabling arbitrary code run, supply chain abuse of LLM plugins
:::
