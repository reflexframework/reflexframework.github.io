...
focus: []
scenario: Trojanized npm packages that steal credentials, inject malicious CI workflows,
  and self-propagate via forced publishing
title: Shai-Hulud (@ctrl/tinycolor) npm compromise
---

::: {.battlecard-metadata}
**Category:** Software supply-chain/security | **Scenario:** Trojanized npm packages that steal credentials, inject malicious CI workflows, and self-propagate via forced publishing
