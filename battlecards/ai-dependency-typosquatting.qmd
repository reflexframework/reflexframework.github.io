...
::: {.battlecard-metadata}
**Category:** Package Ecosystem | **Scenario:** AI Framework Ecosystems

**Focus Areas:** fake PyTorch/TensorFlow packages, malicious Hugging Face libraries, GPU driver/plugin backdoors
:::
