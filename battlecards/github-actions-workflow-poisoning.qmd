...
::: {.battlecard-metadata}
**Category:** CI/CD | **Scenario:** GitHub Actions

**Focus Areas:** poisoned workflows, unpinned actions, malicious PR triggers
:::
...
*   **Document advanced reconnaissance:** Add details on how attackers use GitHub's API and search functionality to identify vulnerable workflow patterns at scale
*   **Include timing attack patterns:** Research and document when attacks typically occur (during maintainer vacation, high-activity periods, etc.)
:::
...
### TODOs for Enhancement
*   **Add audit time estimation:** Provide guidelines for time required to audit workflows based on repository size and complexity
*   **Create workflow risk scoring:** Develop framework for prioritizing workflow security fixes by business impact and attack likelihood
:::
...
### TODOs for Enhancement
*   **Add migration cost analysis:** Document time and effort required to pin actions and implement OIDC across different organization sizes
*   **Create phased implementation guide:** Provide step-by-step approach for hardening workflows without disrupting development velocity
*   **Address enterprise challenges:** Add specific guidance for organizations with hundreds of repositories and complex approval processes
:::
...
### TODOs for Enhancement
*   **Document emergency procedures:** Create step-by-step guide for rapidly revoking compromised secrets and restoring CI/CD functionality
*   **Balance security vs velocity:** Provide guidance on maintaining development speed while implementing strict environment controls
*   **Link to detection systems:** Create clear integration between environment restrictions and monitoring alerts in Expose stage
:::
...
### TODOs for Enhancement
*   **Add alert tuning methodology:** Document systematic approach for optimizing GitHub Actions security alerts and reducing false positives
*   **Create baseline establishment:** Provide framework for defining normal CI/CD behavior patterns to improve anomaly detection
*   **Include cost-effective monitoring:** Add guidance for implementing comprehensive monitoring within smaller organization budgets
:::
::: {.callout-note appearance="default" icon="💪"}
## eXercise
...
### TODOs for Enhancement
*   **Define exercise schedule:** Specify recommended frequency for GitHub Actions security drills (monthly tabletops, quarterly live exercises)
*   **Include cross-functional coordination:** Add guidance for involving security, legal, and incident response teams in CI/CD security exercises
*   **Document resource requirements:** Provide planning guidance for time and personnel needed for effective workflow security testing
:::
